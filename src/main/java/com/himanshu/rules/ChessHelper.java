...
import com.himanshu.util.AnMoveInterpreter;
...
public class ChessHelper {
    ...
    public static ChessPosition movesToPosition(ChessRules chessRules, AnMoveInterpreter anMoveInterpreter, Collection<String> moves) {
        ChessPosition position = chessRules.getInitialPosition();

        for (String move : moves) {
            ChessMovePath movePath = anMoveInterpreter.convertAnToMove(position, move);
