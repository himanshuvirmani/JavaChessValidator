...
import static com.himanshu.model.ChessSide.*;
...
public class ChessBoardModel implements ChessPosition, Serializable {
    ...
    private ChessSide nextPlayerTurn = WHITE;
    ...
    public void setPosition(ChessPosition position) {
        ...
        if (position instanceof ChessBoardModel) {
            ...
            castlingFlags[0] = position.isCastlingAvailable(WHITE, true);
            castlingFlags[1] = position.isCastlingAvailable(WHITE, false);
            castlingFlags[2] = position.isCastlingAvailable(BLACK, true);
            castlingFlags[3] = position.isCastlingAvailable(BLACK, false);
    ...
    public void setInitialPosition() {
        ...
        for (int i = 0; i < 8; i++) {
            pieces[8 + i] = new ChessPiece(ChessPieceType.PAWN, WHITE);
            pieces[64 - 16 + i] = new ChessPiece(ChessPieceType.PAWN, BLACK);
        }

        setPiece(new ChessBoardCoord(0, 0), new ChessPiece(ChessPieceType.ROOK, WHITE));
        setPiece(new ChessBoardCoord(1, 0), new ChessPiece(ChessPieceType.KNIGHT, WHITE));
        setPiece(new ChessBoardCoord(2, 0), new ChessPiece(ChessPieceType.BISHOP, WHITE));
        setPiece(new ChessBoardCoord(3, 0), new ChessPiece(ChessPieceType.QUEEN, WHITE));
        setPiece(new ChessBoardCoord(4, 0), new ChessPiece(ChessPieceType.KING, WHITE));
        setPiece(new ChessBoardCoord(5, 0), new ChessPiece(ChessPieceType.BISHOP, WHITE));
        setPiece(new ChessBoardCoord(6, 0), new ChessPiece(ChessPieceType.KNIGHT, WHITE));
        setPiece(new ChessBoardCoord(7, 0), new ChessPiece(ChessPieceType.ROOK, WHITE));

        setPiece(new ChessBoardCoord(0, 7), new ChessPiece(ChessPieceType.ROOK, BLACK));
        setPiece(new ChessBoardCoord(1, 7), new ChessPiece(ChessPieceType.KNIGHT, BLACK));
        setPiece(new ChessBoardCoord(2, 7), new ChessPiece(ChessPieceType.BISHOP, BLACK));
        setPiece(new ChessBoardCoord(3, 7), new ChessPiece(ChessPieceType.QUEEN, BLACK));
        setPiece(new ChessBoardCoord(4, 7), new ChessPiece(ChessPieceType.KING, BLACK));
        setPiece(new ChessBoardCoord(5, 7), new ChessPiece(ChessPieceType.BISHOP, BLACK));
        setPiece(new ChessBoardCoord(6, 7), new ChessPiece(ChessPieceType.KNIGHT, BLACK));
        setPiece(new ChessBoardCoord(7, 7), new ChessPiece(ChessPieceType.ROOK, BLACK));
    ...
    public boolean equals(Object obj) {
        ...
        if (obj instanceof ChessBoardModel) {
            ...
            for (int i = 0; i < 64; i++) {
                result = result && pieces[i].equals(oModel.pieces[i]);
            }
        }
